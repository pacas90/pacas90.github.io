...
document.getElementById("file-dialog-add-image").addEventListener("click",function(){
	if(fileInput.files[0] === undefined && document.getElementById("import-from-url-input").value === "") {
		Snackbar.show({
      text: "No image uploaded or imported!",
      duration: 2000,
...
function disableTools() {
	for(let i = 0; i < tools.length; i++) {
		...
		tools_settings[i].className = "selected-tool-settings";
	}
	Crop.disable();
