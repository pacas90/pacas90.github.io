...
function matchAspectRatio(el,image) {
 ...
 if(height > maxHeight) {
  ...
  var Crop = {
      ...
      tools[0].classList.remove("active-tool-btn");
   ...
   // canvasArea.style.top = canvas.getBoundingClientRect().top+"px"
  //  canvasArea.style.left = canvas.getBoundingClientRect().left+"px"
